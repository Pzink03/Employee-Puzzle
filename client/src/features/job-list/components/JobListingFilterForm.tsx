...
export function JobListingFilterForm({className, form}: JobListingFilterFormProps) {
    ...
    return <Form {...form}>
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            />
            <JobListingSelectForm control={form.control} label="Job Type" name="type" options={JOB_LISTING_TYPES} />
            <JobListingSelectForm control={form.control} label="Experience Level" name="experienceLevel" options={JOB_LISTING_EXPERIENCE_LEVELS} />
                ...
                <div className="flex flex-col justify-end gap-4">
                    ...
                    render={({ field }) => (
                        <FormItem className="flex gap-3 space-y-0">
                            ...
                            <FormLabel className="space-y-1 leading-none">Show Hidden</FormLabel>
                        </FormItem>
                        )}
                    />
                    <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex gap-3 space-y-0">
                            ...
                            <FormLabel className="space-y-1 leading-none">Only Show Favorites</FormLabel>
                        </FormItem>
                        )}
                    />
                </div>
